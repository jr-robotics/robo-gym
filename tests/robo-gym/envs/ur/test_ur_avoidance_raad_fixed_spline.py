...
def env(request):
    env = gym.make('AvoidanceRaad2022TestURSim-v0', ip='robot-servers', ur_model=request.param)
...
test_ur_fixed_joints = [
    ('AvoidanceRaad2022TestURSim-v0', False, False, False, False, False, True, 'ur5'), # fixed wrist_3
    ('AvoidanceRaad2022TestURSim-v0', True, False, True, False, False, False, 'ur5'), # fixed Base and Elbow
]
