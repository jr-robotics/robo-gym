...
def env_creator_mir(config):
    return NoObstacleNavigationMir100Sim(**config)


register_env(
    name="NoObstacleNavigationMir100Sim-v0",
    env_creator=env_creator_mir,
)
...
if __name__ == "__main__":
    ...
    config = (
        ...
        .get_default_config()
        .environment("NoObstacleNavigationMir100Sim-v0", env_config={"ip": "127.0.0.1", "gui": False},)
