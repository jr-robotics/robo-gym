...
class EndEffectorPositioningUR(URBaseEnv):
    ...
    Args:
        ...
        fix_base (bool): Whether the base joint stays fixed or is moveable. Defaults to False.
        fix_shoulder (bool): Whether the shoulder joint stays fixed or is moveable. Defaults to False.
        fix_elbow (bool): Whether the elbow joint stays fixed or is moveable. Defaults to False.
        fix_wrist_1 (bool): Whether the wrist 1 joint stays fixed or is moveable. Defaults to False.
        fix_wrist_2 (bool): Whether the wrist 2 joint stays fixed or is moveable. Defaults to False.
        fix_wrist_3 (bool): Whether the wrist 3 joint stays fixed or is moveable. Defaults to True.
    ...
    def env_action_to_rs_action(self, action) -> np.array:
        ...
        if self.restrict_wrist_1:
            ...
            min_wrist1 = -3.48
            wrist1 = (
                ((rs_action[3] - min_action) * (max_wrist1 - min_wrist1))
